...
a few inputs required to start.
...
e.g to search for an address from a list of sites the speific word would be the street number and street name (13 pitt)
and the unspecific word would be just the street name (pitt).
...
The following 3 contain links that could not be access by the script, these links are generally toxic but there is sometimes false positives so just look at the link to determine if it was just toxic or need to be manually searched
